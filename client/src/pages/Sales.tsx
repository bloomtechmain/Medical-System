...
export default function Sales() {
  ...
  const columns = [
    ...
    { key: 'payment_method', header: 'Payment', render: (r: any) => <span className="capitalize">{r.payment_method}</span> },
    { key: 'sold_at', header: 'Date & Time', render: (r: any) => formatDateTime(r.sold_at) },

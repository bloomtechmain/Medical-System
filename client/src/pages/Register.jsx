...
export default function Register() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await authApi.register({ name, email, password, role: selectedRole, profile });
      login(res.user, res.token);
      toast.success('Account created successfully!');
      const routes = { doctor: '/doctor', pharmacist: '/pharmacist', patient: '/patient', laboratory: '/laboratory' };
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="sm:col-span-2">
                      ...
                      {errors.pharmacy_name && <p className="text-xs text-red-500 mt-1">{errors.pharmacy_name.message}</p>}
                    </div>
                    <div className="sm:col-span-2">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="sm:col-span-2">
                      ...
                      {errors.lab_name && <p className="text-xs text-red-500 mt-1">{errors.lab_name.message}</p>}
                    </div>
                    <div className="sm:col-span-2">
                      ...
                      {errors.lab_type && <p className="text-xs text-red-500 mt-1">{errors.lab_type.message}</p>}
                    </div>
                    <div>
                      <label className="label">Phone Number <span className="text-red-400">*</span></label>

...
export default function Users() {
  ...
  const ROLE_COLORS = { admin: 'bg-purple-100 text-purple-700', pharmacist: 'bg-blue-100 text-blue-700', staff: 'bg-gray-100 text-gray-700' };

  const columns = [
    { key: 'name', header: 'Name' },
    { key: 'email', header: 'Email' },
    { key: 'role', header: 'Role', render: (r) => <span className={`badge ${ROLE_COLORS[r.role]}`}>{r.role}</span> },

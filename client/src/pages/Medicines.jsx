...
export default function Medicines() {
  ...
  const handleEdit = (med) => { reset(med); formModal.open(med); };
  ...
  return (
    <div>
      ...
      <div className="mb-4">
        <input className="input max-w-xs" placeholder="Search medicines..." value={search} onChange={(e) => setSearch(e.target.value)} />
      </div>
